...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(clubCount) => "Избранные клубы (${clubCount})";

  static String m1(workoutCount) => "Тренировки (${workoutCount})";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "workoutArchivePageTitle":
            MessageLookupByLibrary.simpleMessage("История тренировок"),
        "workoutListPageTitle": m1,
        "workoutPageTitle": MessageLookupByLibrary.simpleMessage("Тренировка")
      };
}
