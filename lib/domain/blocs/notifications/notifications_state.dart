...
class NotificationsState with _$NotificationsState {
  ...
  const factory NotificationsState.paymentWorkoutSuccess() = _PaymentWorkoutSuccess;
  const factory NotificationsState.paymentWorkoutReject() = _PaymentWorkoutReject;

  const factory NotificationsState.workoutStatusPlanned() = _WorkoutStatusPlanned;
  const factory NotificationsState.workoutStatusRS() = _WorkoutStatusRS;
  const factory NotificationsState.workoutStatusStarted() = _WorkoutStatusStarted;
  const factory NotificationsState.workoutStatusRF() = _WorkoutStatusRF;
  const factory NotificationsState.workoutStatusFinished() = _WorkoutStatusFinished;
