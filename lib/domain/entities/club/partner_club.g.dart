...
_$_PartnerClub _$$_PartnerClubFromJson(Map<String, dynamic> json) => _$_PartnerClub(
      ...
      facilities:
          (json['facilities'] as List<dynamic>?)?.map((e) => Facility.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      workSchedule: (json['work_schedule'] as List<dynamic>?)
          ...
          .toList(),
      activities:
          (json['activities'] as List<dynamic>?)?.map((e) => Activity.fromJson(e as Map<String, dynamic>)).toList(),
      organization:
          json['organization'] == null ? null : Organization.fromJson(json['organization'] as Map<String, dynamic>),
      documents:
          (json['documents'] as List<dynamic>?)?.map((e) => Document.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$$_PartnerClubToJson(_$_PartnerClub instance) => <String, dynamic>{
      'id': instance.uuid,
