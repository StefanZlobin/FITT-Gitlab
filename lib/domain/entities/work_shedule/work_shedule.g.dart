...
_$_WorkSchedule _$$_WorkScheduleFromJson(Map<String, dynamic> json) => _$_WorkSchedule(
...
Map<String, dynamic> _$$_WorkScheduleToJson(_$_WorkSchedule instance) => <String, dynamic>{
