...
DateSlot _$DateSlotFromJson(Map<String, dynamic> json) {
  return _DateSlot.fromJson(json);
}
...
class _$_DateSlot implements _DateSlot {
  ...
  @override
  String toString() {
    return 'DateSlot(date: $date, timeSlots: $timeSlots)';
  }
