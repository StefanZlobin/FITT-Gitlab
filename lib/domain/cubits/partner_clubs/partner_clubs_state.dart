...
class PartnerClubsState with _$PartnerClubsState {
  ...
  const factory PartnerClubsState.loaded(
      {required List<PartnerClub> partnerClubs}) = _PartnerClubsStateLoaded;
  const factory PartnerClubsState.error({required String error}) =
      _PartnerClubsStateError;
}
