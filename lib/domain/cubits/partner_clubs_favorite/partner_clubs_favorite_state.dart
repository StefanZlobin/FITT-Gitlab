...
class PartnerClubsFavoriteState with _$PartnerClubsFavoriteState {
  const factory PartnerClubsFavoriteState.initial() = _PartnerClubsFavoriteStateInitial;
  ...
  const factory PartnerClubsFavoriteState.error({required String error}) = _PartnerClubsFavoriteStateError;
}
