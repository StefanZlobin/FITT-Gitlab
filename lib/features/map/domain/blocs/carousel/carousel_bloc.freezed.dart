...
class _$_ClubSelected with DiagnosticableTreeMixin implements _ClubSelected {
  const _$_ClubSelected(this.id);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CarouselEvent.clubSelected(id: $id)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CarouselEvent.clubSelected'))
...
abstract class _ClubSelected implements CarouselEvent {
  const factory _ClubSelected(final String id) = _$_ClubSelected;
...
class _$_Initial with DiagnosticableTreeMixin implements _Initial {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'CarouselState.initial'));
  }
